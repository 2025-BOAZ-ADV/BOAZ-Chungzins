...
class LungSoundClassifier(nn.Module):
    def __init__(self, backbone, num_classes=2, freeze_backbone=True):
        """폐 소리 분류기
...
def create_classifier(checkpoint_path=None, num_classes=2, freeze_backbone=True):
    """분류기 생성
    ...
    return LungSoundClassifier(backbone, num_classes, freeze_backbone)
